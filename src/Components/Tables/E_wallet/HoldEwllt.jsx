...
const API_TRANSFER_ENDPOINT = `apiAdmin/v1/wallet/HoldingFundToEwallet`;
...
const HoldEwllt = () => {
  ...
  const handleMemberChange = (e) => {
    ...
    if (selectedMember) {
        console.log(selectedMember,"sele")
      setAvailableBalance(selectedMember?.HoldingAmount);
    } else {
      setAvailableBalance('');
    }
  };
